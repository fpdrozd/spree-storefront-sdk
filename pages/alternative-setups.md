...
The SDK is hosted by the [UNPKG](https://unpkg.com/) CDN. [Follow this link to download version 5.0.0](https://unpkg.com/@spree/storefront-api-v2-sdk@5.0.0/dist/client/index.js) and [this link to download the newest version](https://unpkg.com/@spree/storefront-api-v2-sdk/dist/client/index.js). Include the SDK on a website like so:
